...
PrintTable( {[1]="testing", [2]="testing", [3]="123",} )
end
...
function PANEL:ToTable( bigtable )
	...
	if admino.InternalClientGet( self:GetSpawnName() ) ~= nil then
	if admino.InternalClientGet( self:GetSpawnName() ) == true then tab.admin = true end
	if admino.InternalClientGet( self:GetSpawnName() ) == false then tab.admin = false end
	end
...
function PANEL:Copy()
	...
	if admino.InternalClientGet( self:GetSpawnName() ) ~= nil then
	if admino.InternalClientGet( self:GetSpawnName() ) == true then copy:SetAdminOnly( true ) end
	if admino.InternalClientGet( self:GetSpawnName() ) == false then copy:SetAdminOnly( false ) end
	end
...
spawnmenu.AddContentType( "entity", function( container, obj )
	...
	if admino.InternalClientGet( obj.spawnname ) ~= nil then
	if admino.InternalClientGet( obj.spawnname ) == true then icon:SetAdminOnly( true ) end
	if admino.InternalClientGet( obj.spawnname ) == false then icon:SetAdminOnly( false ) end
	end
